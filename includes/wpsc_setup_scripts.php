...
function WPS_admin_styles( $hook ) {
	// if( get_site_url() == 'http://languagetable:7888' ){
	// 	wp_enqueue_style( 'WPS_admin_styles',  WPS_PLUGIN_URL . 'includes/css/WPS_admin_styles_dev.css', array(), WPS_PLUGIN_VERSION );		
	// }
