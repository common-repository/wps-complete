...
function wpsc_support_plugin_options() {
	...
	switch ( $_GET['tab'] ) {
	    case 'about':
	    		wpsc_sub_tabs( 'about' );
	       		include "WPS_about_tab.php";
	        break;
	     case 'edit_job_quote':
	     		wpsc_sub_tabs( $_GET['tab'] );
	       		include "WPS_template_edit_job_quote_tab.php";
	        break;
	     case 'quotes':
	       		include "WPS_template_users_quotes_tab.php";
	        break;
	    case 'view_job_quote':
	     		wpsc_sub_tabs( $_GET['tab'] );
	       		include "WPS_template_view_job_quote_tab.php";
	        break;
	    case 'account':
	    ...
	    case 'notifications':
	    		wpsc_sub_tabs( $_GET['tab'] );
	        	include "WPS_template_notifications_tab.php";
	        break;
	    case 'homepage':
